           ...
           <div className="relative md:h-screen" 
                ...
                <div className="px-6 pt-6 2xl:container">
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div className="bg-white rounded-lg md:col-span-2 lg:col-span-1" >
                            {/* <Link to="/home-mon/perizinan"> */}
                                <div className="h-full py-8 px-6 space-y-6 rounded-lg  border border-gray-200 bg-white">
                                    <div className="flex border-b -mt-4 justify-between ">
                                        <div className="font-semibold ">
                                            <h1> Total Penjuaaln</h1>
                                        </div>
                                        <div className="">
                                            <BsThreeDotsVertical />
                                        </div>
                        ...
                        <div>
                            <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                                <h5 className="text-xl text-gray-700">Penjualan Bulanan</h5>
                                <div className="my-8">
                        ...
                        <div>
                            <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                                ...
                                <svg className="w-40 m-auto mt-2" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="mt-6">
                                    <h5 className="text-xl text-gray-700 text-center">Penjualan Satu Tahun Terakhir</h5>
                                    <div className="mt-2 flex justify-center gap-4">
                                    ...
                                    <span className="block text-center text-gray-500">Peerbandingan dengan tahun lalu</span>
                                </div>
                                <table className="mt-6 -mb-2 w-full text-gray-600">
                                    <tbody>
                                        <tr>
                                            <td className="py-2">Tahun Lalu</td>
                                        ...
                                        <tr>
                                            <td className="py-2">Tahun Sekarang</td>
                                            <td className="text-gray-500">0</td>
                                            <td>
                                                <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
