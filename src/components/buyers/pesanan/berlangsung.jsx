...
import { getOrderBuyer } from "../../../slices/buyer/buyerSlice";
...
function Berlangsung(){
    ...
    return(
        ...
        {/* {getOrder.rows.length ? ( */}
                <div className="grid grid-cols-1 gap-4 ">
                    { 
                     getOrder.rows?.map((item,idx)=>(                               
                        <div key={idx} className=" card bg-white h-full ">
                            <div className=" w-full justify-between mx-auto px-4 flex">
                                <div>
                                    <h1>{item ? item.code : ''}</h1>
                                </div>
                            ...
                            <div className="px-4 mb-4 py-4 mx-4 md:mx-auto max-w-4xl border border-gray-300 rounded shadow-xl">
