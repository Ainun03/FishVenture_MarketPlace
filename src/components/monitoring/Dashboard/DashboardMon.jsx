...
function DashboardMon() {
    ...
    var countfiltered = check.filter(function (element) {
        return element.status === 'submission';
    }).length
            ...
            <div className="relative md:h-screen" 
                ...
                data-aos-delay="500">
                    <div className="">
                        ...
                        { 
                            countfiltered === 0 ? (
                                <div className="bg-green-500 flex justify-center w-full p-3 rounded-b-2xl -mt-4">
                                ...
                                <Link to="/home-mon/perizinan">
                                    <div className="bg-red-500 flex justify-center hover:bg-red-300 hover:text-gray-600 hover:text-base cursor-pointer w-full p-3 rounded-b-2xl -mt-4">
                                        <h3 className="font-medium text-white py-2 px-2  ">
                                            Anda Memiliki <span className="font-bold text-xl text-green-400"> {countfiltered} </span> Pengajuan Yang Perlu disetujui
                                        </h3>
                                    </div>
                                </Link>
                            )
                ...
                <div class="px-6 pt-6 2xl:container">
                    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div class="bg-white rounded-lg md:col-span-2 lg:col-span-1" >
                            <Link to="/home-mon/perizinan">
                                <div class="h-full py-8 px-6 space-y-6 rounded-lg  border border-gray-200 bg-white">
                                    <div className="flex border-b -mt-4 justify-between ">
                        ...
                        <div>
                            <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                                <h5 class="text-xl text-gray-700">Penjualan Bulanan</h5>
                                <div class="my-8">
                        ...
                        <div>
                            <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                                <div className="flex pb border-b -mt-4 justify-between ">
                                    <div className="font-semibold ">
                                        <h1> Total Penjualan Tahunan</h1>
                                    </div>
                                    <div className="">
                                        <BsThreeDotsVertical />
                                    </div>
                                </div>
                                <svg class="w-40 m-auto mt-2" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mt-6">
                                    <h5 class="text-xl text-gray-700 text-center">Penjualan Satu Tahun Terakhir</h5>
                                    <div class="mt-2 flex justify-center gap-4">
                                    ...
                                    <span class="block text-center text-gray-500">Peerbandingan dengan tahun lalu</span>
                                </div>
                                <table class="mt-6 -mb-2 w-full text-gray-600">
                                    <tbody>
                                        <tr>
                                            <td class="py-2">Tahun Lalu</td>
                                        ...
                                        <tr>
                                            <td class="py-2">Tahun Sekarang</td>
                                            <td class="text-gray-500">0</td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
